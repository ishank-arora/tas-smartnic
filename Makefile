...
install: tas_nic/tas_nic tas_host/tas_host lib/libtas_sockets.so lib/libtas_interpose.so \
	lib/libtas.so tools/statetool
	mkdir -p $(DESTDIR)$(SBINDIR)
	cp tas_host/tas_host $(DESTDIR)$(SBINDIR)/tas_host
	cp tas_nic/tas_nic $(DESTDIR)$(SBINDIR)/tas_nic
...
uninstall:
	rm -f $(DESTDIR)$(SBINDIR)/tas_host
	rm -f $(DESTDIR)$(SBINDIR)/tas_nic
